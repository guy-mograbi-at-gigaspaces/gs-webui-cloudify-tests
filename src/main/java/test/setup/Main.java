...
import webui.tests.setup.SetupManager;
...
//	private SetupActionsManager.Main setupManager;
	private SetupActionsManager.TestNg testNg;
	
	
	public void setTestNg(SetupActionsManager.TestNg testNg) {
		this.testNg = testNg;
	}
